...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/achauhancb-cbws0422/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>achauhancb-cbws0422</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>achauhancb-cbws0422</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/achauhancb-cbws0422/pipeline-template-catalog.git</repositoryUrl>
              <traits>
